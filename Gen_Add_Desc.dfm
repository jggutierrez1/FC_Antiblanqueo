object fGen_Add_Desc: TfGen_Add_Desc
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object Label6: TLabel
    ...
    Width = 261
    Height = 25
    Caption = 'DESCUENTOS AUTOMATICOS'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -19
    Font.Name = 'Segoe UI'
  ...
  object oid_cliente_descuento: TDBEdit
    Left = 336
    Top = 78
    Width = 102
    Height = 25
    DataField = 'id_cliente_descuento'
    DataSource = oDs_De
    Enabled = False
    ReadOnly = True
    TabOrder = 0
  end
  object otipo_descuento: TDBLookupComboboxEh
    Left = 184
    Top = 121
    Width = 254
    Height = 25
    ...
    DataSource = oDs_De
    EditButtons = <>
    KeyField = 'desc_codigo'
    ListField = 'desc_nombre'
    ListSource = dmGen_Data_Mod.odTipDe
    TabOrder = 1
    Visible = True
  end
  object ofreq_descuento: TDBLookupComboboxEh
    Left = 184
    Top = 164
    Width = 254
    Height = 25
    DynProps = <>
    DataField = 'freq_descuento'
    DataSource = oDs_De
    EditButtons = <>
    KeyField = 'fpcodigo'
    ListField = 'fpnombre'
  ...
  object omonto_descuento: TDBNumberEditEh
    Left = 317
    Top = 208
    Width = 121
    Height = 25
