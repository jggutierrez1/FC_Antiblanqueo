object fGen_Add_RefB: TfGen_Add_RefB
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object oId_banco: TDBLookupComboboxEh
    Left = 169
    Top = 121
    Width = 269
    Height = 25
    ...
    EditButtons = <>
    KeyField = 'banc_id'
    ListField = 'banc_descripcion'
    ListSource = dmGen_Data_Mod.odBanc
    TabOrder = 1
    Visible = True
  end
  object oid_cliente_referencias_bancarias: TDBEdit
    Left = 336
    Top = 78
    Width = 102
    Height = 25
    DataField = 'id_cliente_referencias_bancarias'
    DataSource = oDs_Rb
    Enabled = False
    ReadOnly = True
    TabOrder = 0
  end
  object oNum_cuenta: TDBEdit
    Left = 169
    Top = 164
    Width = 269
    Height = 25
