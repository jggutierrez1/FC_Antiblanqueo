object fGen_Pop_Pon: TfGen_Pop_Pon
  Left = 0
  Top = 0
  ...
  object Label3: TLabel
    ...
    Width = 89
    Height = 13
    Caption = 'Descrici'#243'n/Detalle:'
  end
  object Label4: TLabel
    ...
    Width = 147
    Height = 13
    Caption = 'Probabilidad [PONDERACION]:'
  end
  ...
  object Label1: TLabel
    ...
    Width = 363
    Height = 25
    Caption = 'SISTEMA DE PONDERACION DE RIESGOS'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -19
    Font.Name = 'Segoe UI'
  ...
  object oLst_prob_ponderacion: TDBLookupComboboxEh
    Left = 216
    Top = 144
    Width = 121
    Height = 23
  ...
  object oLst_impa_ponderacion: TDBLookupComboboxEh
    Left = 216
    Top = 188
    Width = 121
    Height = 23
  ...
  object otImpa: TFDTable
    IndexFieldNames = 'impa_autoin'
    Connection = oConn
    UpdateOptions.UpdateTableName = 'mant_nivel_impacto'
    TableName = 'mant_nivel_impacto'
    Left = 384
    Top = 297
  end
  object odImpa: TDataSource
    DataSet = otImpa
    Left = 381
    Top = 241
  end
  object otProva: TFDTable
    IndexFieldNames = 'prov_autoin'
    Connection = oConn
    UpdateOptions.UpdateTableName = 'mant_nivel_provabilidad'
    TableName = 'mant_nivel_provabilidad'
    Left = 315
    Top = 297
  end
  object odProva: TDataSource
    DataSet = otProva
    Left = 313
    Top = 241
  end
