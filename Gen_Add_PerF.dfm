object fGen_Add_PerF: TfGen_Add_PerF
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object Label6: TLabel
    ...
    Width = 373
    Height = 25
    Caption = 'MANTENIMIENTO DE PERFIL FINANCIERO'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -19
    Font.Name = 'Segoe UI'
  ...
  object oMonto_fijo: TDBNumberEditEh
    Left = 313
    Top = 207
    Width = 121
    Height = 25
    Hint = 'Ingrese la edad de a persona'
    DataField = 'monto_fijo'
    DataSource = oDs_Pf
    DisplayFormat = '###,##0.00'
    DynProps = <>
    EditButtons = <>
  ...
  object oId_origen_ingresos: TDBEdit
    Left = 313
    Top = 81
    Width = 121
    Height = 25
    DataField = 'id_origen_ingresos'
    DataSource = oDs_Pf
    Enabled = False
    ReadOnly = True
    TabOrder = 0
  end
  object oLst_Concepto: TDBLookupComboboxEh
    Left = 155
    Top = 165
    Width = 279
    Height = 25
    ...
    EditButtons = <>
    KeyField = 'conci_id'
    ListField = 'conci_descripcion'
    ListSource = dmGen_Data_Mod.odConcIng
    TabOrder = 2
    Visible = True
  end
  ...
  object oOrigen_fondo: TDBEdit
    Left = 155
    Top = 334
    Width = 279
    Height = 25
    CharCase = ecUpperCase
    DataField = 'origen_fondo'
    DataSource = oDs_Pf
    TabOrder = 6
  end
