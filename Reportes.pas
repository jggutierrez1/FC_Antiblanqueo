...
type
  ...
  TpReport = object
    File_Name: string;
    ofrxDBDataset: array [1 .. 15] of TfrxDBDataset;
    OutOption: integer;
    ...
    OnDBDatasetEmptyExit: array [1 .. 15] of boolean;
    OnDBDatasetEmptyMessage: array [1 .. 15] of string;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Queries[i].Zquery := nil;
      Queries[i].AssignDataset := false;
...
begin
  ...
  begin
    ...
    begin
      if (Queries[i].AssignDataset = false) then
      begin
