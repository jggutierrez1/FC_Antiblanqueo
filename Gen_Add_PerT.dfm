object fGen_Add_PerT: TfGen_Add_PerT
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object Label7: TLabel
    ...
    Width = 155
    Height = 17
    Caption = 'N'#250'mero de Transacciones:'
    Color = clBtnFace
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -13
  ...
  object Label6: TLabel
    ...
    Width = 416
    Height = 25
    Caption = 'MANTENIMIENTO DE PERFIL TRANSACCIONAL'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindow
    Font.Height = -19
    Font.Name = 'Segoe UI'
  ...
  object oId_cliente_transacciones: TDBEdit
    Left = 313
    Top = 81
    Width = 121
    Height = 25
    DataField = 'id_cliente_transacciones'
    DataSource = oDs_Pt
    Enabled = False
    ReadOnly = True
    TabOrder = 0
  end
  object oMonto_transaccion: TDBNumberEditEh
    Left = 313
    Top = 208
    Width = 121
    Height = 25
    Hint = 'Ingrese la edad de a persona'
    DataField = 'monto_transaccion'
    DataSource = oDs_Pt
    DisplayFormat = '###,##0.00'
    DynProps = <>
    EditButtons = <>
  ...
  object oLst_Tipo_Trans: TDBLookupComboboxEh
    Left = 155
    Top = 165
    Width = 279
    Height = 25
    DynProps = <>
    DataField = 'cod_tipo_tran'
    DataSource = oDs_Pt
    EditButtons = <>
    KeyField = 'ttcodigo'
    ListField = 'ttnombre'
    ListSource = dmGen_Data_Mod.odTipTr
    TabOrder = 2
    Visible = True
  end
  object oLst_FP: TDBLookupComboboxEh
    Left = 155
    Top = 295
    Width = 279
    Height = 25
    ...
    DataSource = oDs_Pt
    EditButtons = <>
    KeyField = 'fpag_codigo'
    ListField = 'fpag_nombre'
    ListSource = dmGen_Data_Mod.odFormP
    TabOrder = 5
    Visible = True
  end
  ...
  object oNumero_transaccion: TDBNumberEditEh
    Left = 313
    Top = 251
    Width = 121
    Height = 25
  ...
  object oLst_Frec: TDBLookupComboboxEh
    Left = 155
    Top = 337
    Width = 279
    Height = 25
    ...
    KeyField = 'fpcodigo'
    ListField = 'fpnombre'
    ListSource = dmGen_Data_Mod.odFrecP
    TabOrder = 6
    Visible = True
  end
